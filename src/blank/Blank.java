        ...
        do{ 
          ...
          switch (choice){ 
            case 1:  
                ...
                JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM BNI SYARIAH - BOJONEGORO,"
                        + " ambil kartu ATM Anda."); 
                System.exit(0); 
 
            case 2:  
                str1 = JOptionPane.showInputDialog(null,"Masukkan jumlah penyetoran: " ); //menabung 
                s = Integer.parseInt(str1); setor hasil = new setor(); 
                ...
                JOptionPane.showMessageDialog(null,"Untuk bantuan nasabah,\nsilahkan "
                        + "menghubungi call center 555123 (Gratis)","Kartu ATM anda diblokir!",0); 
                  System.exit(0);} 
                  } 
